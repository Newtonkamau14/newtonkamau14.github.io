      ...
      <div className="main-container">
        <div id="intro">
          ...
          <p>
            ...
            Svelte, HTML, CSS, and JavaScript, coupled with proficiency in
            ...
            applications. My commitment to delivering high-quality solutions is
            underscored by a proven track record in creating engaging user
            experiences and optimizing database performance. I am enthusiastic
            about contributing my multifaceted skills to elevate your
            development team and drive innovative projects forward.
          </p>
        </div>
        <div id="skills">
